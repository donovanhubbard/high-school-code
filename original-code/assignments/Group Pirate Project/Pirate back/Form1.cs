...
namespace Scallywags
{
	...
	{	
		...
		public Form1()
		{
			...
			Larry = new Frigate(500,150,worldX,worldY,0,0,0,"Larry",Color.FromArgb(154,36,157), 500,0,0,true, boom, splash, fire, shot);
			frigate1 = new Frigate(500,350,worldX - 200,worldY+5010,6,0,0,"Shelby",Color.Wheat,500,0,0,true, boom, splash, fire, shot);	
			frigate2 = new Frigate(200,150,120,90,2,4,0,"Moe",Color.IndianRed,100,0,0,false,boom,splash,fire,shot);
			frigate3 = new Frigate(200,150,800,25,2,4,0,"Moe",Color.LightCyan,100,0,0,false,boom,splash,fire,shot);
			frigate4 = new Frigate(200,150,400,450,2,4,0,"Moe",Color.FromArgb(120,80,250),100,0,0,false,boom,splash,fire,shot);
			frigate5 = new Frigate(200,150,100,800,2,4,0,"Moe",Color.FromArgb(20,180,250),100,0,0,false,boom,splash,fire,shot);
			ships[0] = frigate1;
			ships[1] = frigate2;
			ships[2] = frigate3;
			ships[3] = frigate4;
	...
	public class Ship
	{
		...
		public SecondaryBuffer boom;
		public SecondaryBuffer splash;
		//public SecondaryBuffer fire;
		public SecondaryBuffer shot;
		protected Smoke Smoke1,Smoke2,Smoke3,Smoke4,Smoke5;
		
		

		public Ship(int hp,int crew,float x, float y,int slide, int cannons,int weight,string name, Color color, int ball, int grape, int chain, bool alive, SecondaryBuffer boom, SecondaryBuffer sound, SecondaryBuffer fire, SecondaryBuffer shot)
		{
	...
	public class Frigate : Ship
	{
		...
		public Frigate (int hp,int crew,float x, float y,int slide, int cannons,int weight,string name, Color color, int ball, int grape, int chain, bool alive, SecondaryBuffer boom, SecondaryBuffer splash, SecondaryBuffer fire, SecondaryBuffer shot):base(hp,crew,x,y,slide,cannons,weight,name,color,ball,grape,chain,alive, boom, splash, fire, shot)
		{
			this.maxHp = 500;
			this.maxCrew = 150;
			this.maxMomentum = 3f;
			this.acceleration = .5f;
			this.Weapon1 = new Weapon(0,0,.7f, splash);
			this.Weapon2 = new Weapon(0,0,.7f, splash);
			this.Weapon3 = new Weapon(0,0,.7f, splash);
			this.Weapon4 = new Weapon(0,0,.7f, splash);
			this.alive = alive;
	...
	public class Weapon
	{
		...
		protected bool alive;
		internal Ball ball;
		protected SecondaryBuffer splash;
		

		public Weapon (float x, float y, float cooldownRate, SecondaryBuffer splash)
		{
			this.x =x;
			this.y = y;
			this.cooldown = 100;
	...
	public abstract class Projectile
	{
		...
		public Projectile(float x, float y,float xDirection,float yDirection, SecondaryBuffer splash)
		{
			this.x = x;
			this.y = y;
	...
	public class Ball:Projectile
	{
		...
		public Ball(float x, float y, float xDirection, float yDirection, SecondaryBuffer splash): base(x,y, xDirection, yDirection, splash)
		{
			this.speed = 7;
			this.range = 300;
			this.splashCount = 11;
